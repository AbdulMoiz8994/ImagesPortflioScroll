    ...
    <>
      ...
      <InstantSearch searchClient={searchClient} indexName={algolia_indexes.products}>
        ...
        <ChildCategoryPage  
          ...
          sidebarLayout='page' 
          categoryName="Προϊόντα σε Προσφορά"
          categoryDescription='Παρακάτω θα βρει προϊόντα σε προσφορά!'
          algolia={{
...
function SEO() {
  return (
    <>
      <Head>
        <title>Products on offer - SFKshop</title>
      </Head>
      ...
      <NextSeo 
        ...
        canonical="https://sfkshop.gr/products-on-sale/"
        robotsProps={{
          maxSnippet: -1,
          maxVideoPreview: -1,
        ...
        openGraph={{
          ...
          type: "article",
          site_name: "SFKshop",
          url: "https://sfkshop.gr/products-on-sale/",
          article: {
