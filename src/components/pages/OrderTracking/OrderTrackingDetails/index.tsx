...
import { consumerKey, consumerSecret, googleMapKey, siteURL } from 'site-settings/site-credentials';
            ...
            <HStack align="flex-start" justify={{ base: "left", md: "center"}}>
              ...
              <Stack spacing="2">
                ...
                <Stack spacing="0">
                  ...
                  <Text>Διεύθυνση: {shipping.address_1}</Text>
                  {/* <Text>State: {shipping.state}</Text> */}
                  <Text>Περιοχή: {shipping.state}</Text>
                  {/* <Text>Postal Code: {shipping.postcode}</Text> */}
                  <Text>Τ.Κ: {shipping.postcode}</Text>
                </Stack>
              </Stack>
            </HStack>
          </Box>
