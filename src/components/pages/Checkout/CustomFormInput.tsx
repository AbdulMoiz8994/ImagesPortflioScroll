import { FormControl, FormLabel, Input, InputProps, Stack, Text, Box, InputGroup, InputRightElement, Icon, InputLeftAddon } from "@chakra-ui/react";
...
const CustomFormInput = React.forwardRef<HTMLInputElement, Props>(({ errorMessage, isError, LeftAddon, IconRight, isRequired, label, errors, fieldName, placeholder, ...restProps }, ref) => {  
